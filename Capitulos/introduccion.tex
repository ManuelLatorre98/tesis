...
\begin{enumerate}
    ...
    \item Implementar el mecanismo de tolerancia a fallos de la aplicación móvil basado en replicación de datos entre dispositivos móviles y la nube para garantizar resiliencia ante fallos de servicios, conectividad y hardware.

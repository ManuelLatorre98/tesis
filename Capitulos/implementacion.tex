...
Descartado el uso de WebSocket se optó por implementar un protocolo de discretización de mensajes sobre TLS, utilizando la librería $react\_native\_tcp\_socket$ \cite{react-native-tcp-socket}.
...
\begin{enumerate}
    \item El receptor lee cuatro bytes del \textit{socket} de comunicaciones TLS.
